...
figure 
plot(OMEGA,C,'r-o'); grid on; 
hold on; plot(OMEGA,Ctheory,'b-',LineWidth=1)
xlabel('\omega'); ylabel('C'); 
legend('computed numerically','theoretical','Location','northwest') 
title('Amplitude as a function of \omega (c = 0)')
